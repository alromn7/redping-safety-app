          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final subId = category.subcategoryIds[index];
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      title: Text(_getSubcategoryDisplayName(subId)),
                      subtitle: Text(_getSubcategoryDescription(subId)),
                      trailing: const Icon(Icons.arrow_forward_ios),
                      onTap: () {
                        Navigator.pop(context);
                        _createHelpRequest(category.categoryId, subId);
                      },
                    ),
                  );
                },
