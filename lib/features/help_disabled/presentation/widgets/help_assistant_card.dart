...
class _HelpAssistantCardState extends State<HelpAssistantCard> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      _activeRequests = await _serviceManager.helpAssistantService
          .getActiveRequests();
    } catch (e) {
      ...
      children: [
        Expanded(
          child: _buildQuickCategoryButton(
            ...
            () => _quickCreateRequest('vehicle', 'breakdown'),
          ),
        ),
        const SizedBox(width: 8),
        Expanded(
          child: _buildQuickCategoryButton(
            ...
            () => _quickCreateRequest('home_security', 'suspicious_activity'),
          ),
        ),
        const SizedBox(width: 8),
        Expanded(
          child: _buildQuickCategoryButton(
            ...
            Icons.pets,
            AppTheme.infoBlue,
            () => _quickCreateRequest('lost_found', 'lost_pet'),
          ),
        ),
      ],
    );
  ...
  void _quickCreateRequest(String categoryId, String subcategoryId) {
