...
/// Integration test for location sharing, phone map opening, and SAR system
class IntegrationTest {
  ...
  Future<void> initialize() async {
    ...
    debugPrint('🧪 IntegrationTest: Initializing services...');

    try {
      // Initialize app service manager
      await _serviceManager.initializeAllServices();
      _isInitialized = true;
      debugPrint('✅ IntegrationTest: All services initialized successfully');
    } catch (e) {
      debugPrint('❌ IntegrationTest: Initialization failed - $e');
      rethrow;
    }
  }
